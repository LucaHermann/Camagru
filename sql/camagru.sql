...
--
-- Hôte : localhost:3306
-- Généré le :  jeu. 04 oct. 2018 à 16:56
...
--
ALTER TABLE `image`
  MODIFY `idimg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=256;
--
...
--
ALTER TABLE `comment`
  ADD CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`img_id`) REFERENCES `image` (`idimg`),
...
ALTER TABLE `like`
  ...
  ADD CONSTRAINT `like_ibfk_2` FOREIGN KEY (`img_id`) REFERENCES `image` (`idimg`);